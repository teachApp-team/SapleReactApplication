...
export declare class IgrIndicatorDisplayTypeCollection extends IgCollection<IndicatorDisplayType, IndicatorDisplayType> {
    constructor(list?: IndicatorDisplayType[]);
    protected _ensureOuter(item: any): IndicatorDisplayType;
