 ...
 * @hidden
 */
export let BarTrendFitCalculator = /*@__PURE__*/ (() => {
    class BarTrendFitCalculator extends Base {
        static a(a, b, c, d, e, f, g, h, i, j, k) {
            ...
            for (let l = 0; l < c.f.height; l += 2) {
                let m = l / (c.f.height - 1);
                let n = j + m * (k - j);
                let o = NaN;
                switch (b) {
                    case 1:
    ...
    BarTrendFitCalculator.$t = /*@__PURE__*/ markType(BarTrendFitCalculator, 'BarTrendFitCalculator');
    return BarTrendFitCalculator;
})();
//# sourceMappingURL=BarTrendFitCalculator.js.map
