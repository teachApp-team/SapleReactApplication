...
export class IgrRingSeriesCollection extends IgCollection {
    constructor(list) {
        super();
    ...
    _createInnerColl() {
        ...
        let coll = new SyncableObservableCollection$2(IgrRingSeriesBase.$type, RingSeriesBase_internal.$type, 0);
...
//# sourceMappingURL=igr-ring-series-collection.js.map
