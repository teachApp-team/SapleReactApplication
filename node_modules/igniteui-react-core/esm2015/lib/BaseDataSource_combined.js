...
export let BaseDataSource = /*@__PURE__*/ (() => {
    class BaseDataSource extends Base {
        constructor() {
            ...
            this.v = false;
            this.d = null;
            this.k = new DefaultDataSourceDataProviderUpdateNotifier(this);
            this.r = new SortDescriptionCollection();
            this.q = new SortDescriptionCollection();
            this.s = new SummaryDescriptionCollection();
            this.r.n(runOn(this, this.cn));
            this.q.n(runOn(this, this.br));
            this.s.n(runOn(this, this.co));
            this.h = new FilterExpressionCollection();
            this.h.m(runOn(this, this.bp));
            this.t = new TransactionService(runOn(this, this.bt), runOn(this, this.clone1), new TransactionKeyEqualityComparer());
            let a = this.t;
            a.stateChanged = delegateCombine(a.stateChanged, runOn(this, this.cj));
        }
        cj(a, b) {
            if (a == 0 || a == 1) {
        ...
        updatePropertyAtKey(a, b, c, d = false) {
            if (this.ao()) {
                ...
                if (a.length == 1 && typeCast(DataSourceSpecialRow.$, a[0]) !== null) {
                    let f = typeCast(DataSourceSpecialRow.$, a[0]);
                    if (f.rowType == 3) {
                        e = f;
        ...
        removeItemByKey(a) {
            if (this.ao()) {
                let b = null;
                if (a.length == 1 && typeCast(DataSourceSpecialRow.$, a[0]) !== null) {
                    let c = typeCast(DataSourceSpecialRow.$, a[0]);
                    if (c.rowType == 3) {
                        b = c;
                        if (this.actualPrimaryKey != null) {
                            a = new Array(this.actualPrimaryKey.length);
        ...
        commitEdits(a) {
            if (this.ao()) {
                let b = this.t.c(null).length > 0;
                let c = this.t.s(a, this.isBatchingEnabled);
                if (c == -1 && b) {
                    if (this.updateNotifier != null) {
        ...
        e(a) {
            if (a.length == 1 && typeCast(DataSourceSpecialRow.$, a[0]) !== null) {
                let b = typeCast(DataSourceSpecialRow.$, a[0]);
                if (b.rowType == 3) {
                    if (this.actualPrimaryKey != null) {
                        a = new Array(this.actualPrimaryKey.length);
                        this.getPrimaryKeyValue(b.targetRow, a);
        ...
        cloneProperties(a) {
            ...
            if (b != null) {
                ...
                for (let e = 0; e < this.filterExpressions.j.count; e++) {
