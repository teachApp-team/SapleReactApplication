...
var ItemLegend = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(ItemLegend, _super);
    function ItemLegend() {
    ...
    ItemLegend.prototype.bf = function (a, b) {
        var e_4, _a;
        this.ak.af();
        try {
            var c = this.be(b);
    ...
    ItemLegend.prototype.bd = function (a) {
        return this.bb.ap(a);
    };
...
var ItemLegendView = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(ItemLegendView, _super);
