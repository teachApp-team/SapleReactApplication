...
export let ItemTooltipLayerFrame = /*@__PURE__*/ (() => {
    class ItemTooltipLayerFrame extends Frame {
        constructor() {
            ...
            this.f = new List$1(Number_$type, 0);
            this.l = new List$1(Base.$, 0);
            this.j = new List$1(Base.$, 0);
            this.i = new List$1(Base.$, 0);
        ...
        c(a, b, c) {
            ...
            InterpolationUtil.c(Base.$, this.l, a, d.l, e.l, () => null, (f, g, h, i) => i);
            InterpolationUtil.c(Base.$, this.j, a, d.j, e.j, () => null, (f, g, h, i) => i);
            InterpolationUtil.c(Base.$, this.i, a, d.i, e.i, () => null, (f, g, h, i) => i);
        }
    }
    ItemTooltipLayerFrame.$t = /*@__PURE__*/ markType(ItemTooltipLayerFrame, 'ItemTooltipLayerFrame', Frame.$);
