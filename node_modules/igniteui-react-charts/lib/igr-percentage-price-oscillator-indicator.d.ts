...
* ```
*/
export declare class IgrPercentagePriceOscillatorIndicator extends IgrStrategyBasedIndicator<IIgrPercentagePriceOscillatorIndicatorProps> {
    protected createImplementation(): PercentagePriceOscillatorIndicator;
    /**
                                 * @hidden
                                 */
    readonly i: PercentagePriceOscillatorIndicator;
    constructor(props: IIgrPercentagePriceOscillatorIndicatorProps);
    /**
...
export interface IIgrPercentagePriceOscillatorIndicatorProps extends IIgrStrategyBasedIndicatorProps {
    /**
     * Gets or sets the short moving average period for the current PercentagePriceOscillatorIndicator object.
     * The typical, and initial, value for short PPO periods is 10.
    *
