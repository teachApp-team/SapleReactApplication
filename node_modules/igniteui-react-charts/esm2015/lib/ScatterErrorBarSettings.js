 ...
 * @hidden
 */
export let ScatterErrorBarSettings = /*@__PURE__*/ (() => {
    class ScatterErrorBarSettings extends ErrorBarSettingsBase {
        constructor() {
            super();
            this.q = null;
            this.propertyUpdated = delegateCombine(this.propertyUpdated, runOn(this, this.ap));
        }
        get r() {
            return this.q;
        }
