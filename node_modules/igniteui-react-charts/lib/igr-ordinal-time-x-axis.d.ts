...
* ```
*/
export declare class IgrOrdinalTimeXAxis<P extends IIgrOrdinalTimeXAxisProps = IIgrOrdinalTimeXAxisProps> extends IgrCategoryXAxis<P> {
    protected createImplementation(): OrdinalTimeXAxis;
    /**
                                 * @hidden
                                 */
    readonly i: OrdinalTimeXAxis;
    constructor(props: P);
    /**
...
export interface IIgrOrdinalTimeXAxisProps extends IIgrCategoryXAxisProps {
    /**
     * Gets or sets the DateTime mapping property for the axis.
    */
    dateTimeMemberPath?: string;
