...
export let KDTree2D = /*@__PURE__*/ (() => {
    class KDTree2D extends Base {
        ...
        m(a, b, c, d, e) {
            ...
            let f = this.q.next2(b, c);
            let g = this.l(a, d, b, c, f);
            let h = g - b + 1;
            if (h == e) {
                return g;
            }
        ...
        r(a, b, c, d, e, f, g, h) {
            ...
            if (j < a.c) {
                ...
                for (let m = 0; m < a.b.count; m++) {
                    let n = this.i(b, c, a.b._inner[m].c, a.b._inner[m].d);
                    if (n > k) {
                        k = n;
                        l = m;
                    }
