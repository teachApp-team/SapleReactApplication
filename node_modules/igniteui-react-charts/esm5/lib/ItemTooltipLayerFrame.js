 ...
 * @hidden
 */
var ItemTooltipLayerFrame = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(ItemTooltipLayerFrame, _super);
    function ItemTooltipLayerFrame() {
        ...
        _this.f = new List$1(Number_$type, 0);
        _this.l = new List$1(Base.$, 0);
        _this.j = new List$1(Base.$, 0);
        _this.i = new List$1(Base.$, 0);
        _this.m = new List$1(Number_$type, 0);
        _this.k = new List$1(Number_$type, 0);
        _this.h = new List$1(Brush.$, 0);
        return _this;
    }
    ItemTooltipLayerFrame.prototype.c = function (a, b, c) {
        var d = b;
        var e = c;
        Frame.b(this.o, a, d.o, e.o);
        Frame.b(this.n, a, d.n, e.n);
        Frame.b(this.g, a, d.g, e.g);
        Frame.b(this.f, a, d.f, e.f);
        Frame.b(this.m, a, d.m, e.m);
        Frame.b(this.k, a, d.k, e.k);
        FrameExtended.a(this.h, a, d.h, e.h, 0);
        InterpolationUtil.c(Base.$, this.l, a, d.l, e.l, function () { return null; }, function (f, g, h, i) { return i; });
        InterpolationUtil.c(Base.$, this.j, a, d.j, e.j, function () { return null; }, function (f, g, h, i) { return i; });
        InterpolationUtil.c(Base.$, this.i, a, d.i, e.i, function () { return null; }, function (f, g, h, i) { return i; });
    };
    ItemTooltipLayerFrame.$t = markType(ItemTooltipLayerFrame, 'ItemTooltipLayerFrame', Frame.$);
    return ItemTooltipLayerFrame;
}(Frame));
export { ItemTooltipLayerFrame };
//# sourceMappingURL=ItemTooltipLayerFrame.js.map
