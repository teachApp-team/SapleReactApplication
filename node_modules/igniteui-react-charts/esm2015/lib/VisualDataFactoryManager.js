 ...
 * @hidden
 */
export let VisualDataFactoryManager = /*@__PURE__*/ (() => {
    class VisualDataFactoryManager extends Base {
        static register() {
    ...
    VisualDataFactoryManager.$t = /*@__PURE__*/ markType(VisualDataFactoryManager, 'VisualDataFactoryManager');
