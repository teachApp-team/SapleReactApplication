...
export declare class IgrFinancialChartRangeSelectorOptionCollection extends IgCollection<FinancialChartRangeSelectorOption, FinancialChartRangeSelectorOption> {
    constructor(list?: FinancialChartRangeSelectorOption[]);
    protected _ensureOuter(item: any): FinancialChartRangeSelectorOption;
