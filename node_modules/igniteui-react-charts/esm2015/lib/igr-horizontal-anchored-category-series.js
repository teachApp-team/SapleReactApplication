...
* ```
*/
export class IgrHorizontalAnchoredCategorySeries extends IgrAnchoredCategorySeries {
    constructor(props) {
        super(props);
    ...
    */
    get xAxis() {
        ...
        if (!this.i.xAxis.externalObject) {
            let e = IgrCategoryAxisBase._createFromInternal(this.i.xAxis);
            if (e) {
    ...
    */
    get yAxis() {
        ...
        if (!this.i.yAxis.externalObject) {
            let e = IgrNumericYAxis._createFromInternal(this.i.yAxis);
            if (e) {
