...
export declare abstract class UIElementPropertyAccessorFactory extends Base {
    static $t: Type;
    private static b;
    static readonly c: UIElementPropertyAccessorFactory;
    abstract a(a: UIElementPropertyId): UIElementPropertyAccessor;
}
/**
 * @hidden
 */
export declare class PlatformUIElementPropertyAccessorFactory extends UIElementPropertyAccessorFactory {
    static $t: Type;
    constructor();
    a(a: UIElementPropertyId): UIElementPropertyAccessor;
    private d;
}
