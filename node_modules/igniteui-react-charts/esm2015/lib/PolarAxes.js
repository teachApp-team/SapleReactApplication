...
export let PolarAxes = /*@__PURE__*/ (() => {
    class PolarAxes extends Base {
        ...
        e(a, b, c, d, e, f, g, h) {
            ...
            let n;
            let o;
            let p = Math.min(this.a.kb, this.a.ka);
            let q = Math.max(this.a.kb, this.a.ka);
            let r = Math.min(this.b.ka, this.b.kb);
            let s = Math.max(this.b.ka, this.b.kb);
            let t = this.a.j1;
            let u = this.a.ca;
            let v = this.b.j1;
            let w = this.b.ca;
