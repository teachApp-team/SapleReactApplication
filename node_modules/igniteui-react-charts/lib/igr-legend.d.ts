...
import { ReactWrapper } from "igniteui-react-core";
/**
...
* ```
*/
export declare class IgrLegend extends IgrLegendBase<IIgrLegendProps> {
    ...
    constructor(props: IIgrLegendProps);
    private _wrapper;
    destroy(): void;
...
export interface IIgrLegendProps extends IIgrLegendBaseProps {
    /**
 * Gets or sets the current Legend object's orientation.
*
* ```ts
