 ...
 * @hidden
 */
export let MarkerTemplates = /*@__PURE__*/ (() => {
    class MarkerTemplates extends Base {
        static n(a, b, c) {
            a.beginPath();
            let d = b.actualItemBrush;
            let e = b.outline;
            if (d != null) {
                if (d.isGradient) {
                    let f = c.availableWidth / 2;
                    let g = c.availableHeight / 2;
                    let h = c.xPosition - f;
                    let i = c.yPosition - f;
                    h += c.renderOffsetX;
                    i += c.renderOffsetY;
                    let j = CanvasViewRenderer.j(a, d, h, i, h + c.availableWidth, i + c.availableHeight, b.thickness, false);
                    a.fillStyle = j;
                }
                else {
            ...
            if (b.outline != null) {
                if (b.outline.isGradient) {
                    let k = c.availableWidth / 2;
                    let l = c.availableHeight / 2;
                    let m = c.xPosition - k;
                    let n = c.yPosition - k;
                    m += c.renderOffsetX;
                    n += c.renderOffsetY;
                    let o = CanvasViewRenderer.j(a, b.outline, m, n, m + c.availableWidth, n + c.availableHeight, b.thickness, true);
                    a.strokeStyle = o;
                }
                else {
        ...
        static d(a) {
            ...
            let d = Math.min(a.availableWidth, a.availableHeight) / 2;
        ...
        static m(a) {
            ...
            let c = a.data;
            MarkerTemplates.n(b, c, a);
            let d = (a.availableHeight / 2);
            let e = (a.availableWidth / 2);
            let f = (a.xPosition - e);
            let g = (a.yPosition - d);
            b.moveTo(f, g);
        ...
        static c(a) {
            ...
            let d = (a.availableHeight / 2);
            let e = (a.availableWidth / 2);
            let left_ = (a.xPosition - e);
            let top_ = (a.yPosition - d);
        ...
        static h(a) {
            ...
            b.lineTo(f + ((1.6499999761581421 / 8) * a.availableWidth), g + ((7.2360000610351562 / 8) * a.availableHeight));
            b.lineTo(f + ((6.3499999046325684 / 8) * a.availableWidth), g + ((7.2360000610351562 / 8) * a.availableHeight));
        ...
        static i(a) {
            ...
            b.lineTo(f + ((1.6488000154495239 / 8) * a.availableWidth), g + ((7.2360000610351562 / 8) * a.availableHeight));
            b.lineTo(f + ((4 / 8) * a.availableWidth), g + ((6 / 8) * a.availableHeight));
            b.lineTo(f + ((6.3512 / 8) * a.availableWidth), g + ((7.2360000610351562 / 8) * a.availableHeight));
    ...
    MarkerTemplates.$t = /*@__PURE__*/ markType(MarkerTemplates, 'MarkerTemplates');
    return MarkerTemplates;
})();
//# sourceMappingURL=MarkerTemplates.js.map
