...
export let AnchoredCategorySeriesInteractionManager = /*@__PURE__*/ (() => {
    class AnchoredCategorySeriesInteractionManager extends Base {
        c$b(a, b, c, d, e, f, g, h) {
            ...
            if (e == null || e.cf || f == null || d == null || isNaN_(b.x) || isNaN_(b.y)) {
                return h(b);
            }
            if (c <= 1) {
                return h(b);
            }
            let i = truncate(Math.round(a.eb(b)));
            if (i < 0 || i >= a.bz.count) {
                return h(b);
            }
            let j = intDivide(i, c);
            ...
            let m = a.lr(a.bi);
            let n = new ScalerParams(0, a.bs.m6, a.bs.m5, f.ca, a.bs.mv);
            let o = m.top;
            let p = m.bottom;
            let q = o + (p - o) * b.y;
            let r = f.d1(q, n);
        ...
        c$a(a, b, c, d, e, f) {
            ...
            let j = !g.isEmpty && !h.isEmpty && a.bz != null ? a.bz.indexOf(f) : -1;
            let k = a.lt(a.bi);
            let l = new ScalerParams(0, i, i, c.ca, k);
            let m = new ScalerParams(0, i, i, d.ca, k);
            m.b = a.eh();
            let n = c != null ? c.dy(j, l) : NaN;
            n += e;
            let o = d != null && b != null && j < b.count ? d.dy(b.item(j), m) : NaN;
            if (!isNaN_(n)) {
        ...
        c$c(a, b) {
            ...
            else if (d != null && d.e9 != null) {
                c += "<span>${item." + d.e9 + "}</span><br/>";
            }
            c += "<span";
            let f = a.a0.a$q(a);
        ...
        c$d(a, b, c, d, e, f, g, h) {
            ...
            let j = a.bi.bs;
            let k = a.bi.br;
            let l = a.getEffectiveViewport1(a.bi);
            let m = new ScalerParams(0, j, k, d.ca, l);
            m.b = a.eh();
            let n = a.aj(a.ap(), e.f, f, g, b, true);
            if (n == null) {
                return Rect.empty;
            }
            let o = n[0];
...
//# sourceMappingURL=AnchoredCategorySeriesInteractionManager.js.map
