...
export declare class RearrangedListView extends Base implements ISupportsDataChangeNotifications {
    ...
    v(): SectionData;
    private o;
    p: DataSourcePropertiesComparer;
    private a0;
    a2: IComparer$1<any>;
    private az;
    a1: IComparer$1<any>;
    ...
    t: (item: any) => boolean;
    private aa;
    ab: ISupportsDataChangeNotifications;
    private ac;
    ad: ISupportsExpansionChangeNotifications;
    m: IDataSource;
    ...
    ap: boolean;
    private k;
    l: DataSourceSummaryScope;
    j: DataSourceSectionHeaderDisplayMode;
    private readonly ar;
    b6(): void;
    private bl;
    readonly a5: List$1<SectionData>;
    av: boolean;
    au: boolean;
    aw: boolean;
    private ah;
