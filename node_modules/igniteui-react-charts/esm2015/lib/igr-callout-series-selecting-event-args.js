...
*/
export class IgrCalloutSeriesSelectingEventArgs {
    ...
    */
    get series() {
        ...
        if (!this.i.a.externalObject) {
            let e = IgrSeries._createFromInternal(this.i.a);
            if (e) {
...
//# sourceMappingURL=igr-callout-series-selecting-event-args.js.map
