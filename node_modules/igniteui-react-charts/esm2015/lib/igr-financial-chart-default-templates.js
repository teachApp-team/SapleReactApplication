...
const ToolbarTemplate = (props) => {
    ...
    let IndicatorMenu = props.dataContext.vm.financialChartIndicatorMenu.template;
    let RangeSelector = props.dataContext.vm.financialChartRangeSelector.template;
    let TypePicker = props.dataContext.vm.financialChartTypePicker.template;
...
export class IgrFinancialChartDefaultTemplates {
    constructor() {
