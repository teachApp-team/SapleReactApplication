...
export let BarFramePreparer = /*@__PURE__*/ (() => {
    class BarFramePreparer extends CategoryFramePreparer {
        ...
        w(a, b, c) {
            ...
            let d = a.k;
            let e = new ScalerParams(0, a.m, a.l, a.b.j$a, d);
            let f = new ScalerParams(0, a.m, a.l, a.c.j$a, d);
            let g = b.f;
            ...
            if (this.aa.trendLineType != 0) {
                this.aa.trendlinePreparer.prepareLineCore(a.a.p, this.aa.trendLineType, g, this.aa.trendLinePeriod, (i) => a.c.j$b(i, f), (i) => a.b.j$b(i, e), h);
            }
        }
    }
