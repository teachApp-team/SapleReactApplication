...
export let TreemapView = /*@__PURE__*/ (() => {
    class TreemapView extends Base {
        ...
        ar(a) {
            ...
            this.aa = a;
            this.ab = a;
            let b = this.ab.rootWrapper.width();
            let c = this.ab.rootWrapper.height();
            this.ao();
            ...
            this.k = i.listen("contextmenu", (j) => j.preventDefault());
            this.a.io = new Rect(0, 0, 0, e, f);
            this.ac = i;
            let j = this.aa.get2DCanvasContext(this.ac);
        ...
        ap() {
            let a = this.ab.rootWrapper.width();
            let b = this.ab.rootWrapper.height();
        ...
        ax() {
            ...
            let a = this.a.io.width;
            let b = this.a.io.height;
    ...
    class TreemapLayoutCalculator extends Base {
        ...
        i(a, b, c) {
            ...
            if (b.b != null && b.b.count > 0) {
                ...
                let i = new Rect(0, d.left - e.c, d.top - e.e, d.width + f, d.height + g);
                return i;
            }
            else {
                return d;
        ...
        g(a, b, c, d) {
            if (b.b != null && b.b.count > 0) {
                ...
                let h = new Rect(0, c.left + e.c, c.top + e.e, c.width - f, c.height - g);
                a.m(b, h);
                a.n(b, true);
            }
            else {
    ...
    class Treemap extends Base {
        ...
        hb() {
            ...
            for (let aa = 0; aa < this.f.e.count; aa++) {
                ...
                let ad = this.h9(ac, u, v);
                let ae = this.ie(ac);
                let af = this.ia(ac);
                let ag = this.ds(ac);
                let ah = this.f7(this.f, ac, g, i, k, m, s, t);
                let ai = this.id(ac, ad, af);
                let aj = this.av(ac);
                let ak = 0;
                if (this.bh(ac)) {
                    ak = this.an.w(ah);
