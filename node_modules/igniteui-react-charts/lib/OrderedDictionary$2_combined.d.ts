 ...
 * @hidden
 */
export declare class OrderedDictionary_Enumerator$2<TKey, TValue> extends Base implements IEnumerator$1<KeyValuePair$2<TKey, TValue>>, IEnumerator {
    static $t: Type;
    protected $tKey: Type;
    protected $tValue: Type;
    private b;
    ...
    readonly current: KeyValuePair$2<TKey, TValue>;
    moveNext(): boolean;
    reset(): void;
    dispose(): void;
}
