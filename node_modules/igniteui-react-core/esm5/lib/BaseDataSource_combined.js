...
var BaseDataSource = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function BaseDataSource() {
        ...
        _this.r.n(runOn(_this, _this.cn));
        _this.q.n(runOn(_this, _this.br));
        _this.s.n(runOn(_this, _this.co));
        _this.h = new FilterExpressionCollection();
        _this.h.m(runOn(_this, _this.bp));
        _this.t = new TransactionService(runOn(_this, _this.bt), runOn(_this, _this.clone1), new TransactionKeyEqualityComparer());
        var a = _this.t;
        a.stateChanged = delegateCombine(a.stateChanged, runOn(_this, _this.cj));
        return _this;
    }
    ...
    BaseDataSource.prototype.ci = function (a, b) {
    };
            ...
            if (a.length == 1 && typeCast(DataSourceSpecialRow.$, a[0]) !== null) {
                ...
                if (f.rowType == 3) {
                    ...
                    if (this.actualPrimaryKey != null) {
                        ...
                        this.getPrimaryKeyValue(e_3.targetRow, a);
                    }
                    else {
                        a = ((function () {
                            var $ret = new Array(1);
                            $ret.push(e_3.targetRow);
                            return $ret;
                        })());
                    }
                }
            ...
            if (this.isBatchingEnabled || d) {
                if (this.updateNotifier != null) {
                    ...
                    if (this.isRowPinned(i)) {
                        ...
                        if (k > -1) {
                            this.updateNotifier.notifySetItem(k, e_3, e_3);
                        }
                    }
                }
            }
        ...
        if (this.ao()) {
            ...
            if (a.length == 1 && typeCast(DataSourceSpecialRow.$, a[0]) !== null) {
                ...
                if (c.rowType == 3) {
                    ...
                    if (this.actualPrimaryKey != null) {
                        a = new Array(this.actualPrimaryKey.length);
                        this.getPrimaryKeyValue(b_1.targetRow, a);
                    }
                    else {
                        a = ((function () {
                            var $ret = new Array(1);
                            $ret.push(b_1.targetRow);
                            return $ret;
                        })());
                    }
                }
            ...
            if (this.isBatchingEnabled) {
                if (this.updateNotifier != null) {
                    ...
                    if (this.isRowPinned(e)) {
                        ...
                        if (g > -1) {
                            this.updateNotifier.notifySetItem(g, b_1, b_1);
                        }
                    }
                }
            }
        ...
        if (this.ao()) {
            ...
            for (var d = 0; d < b.length; d++) {
                ...
                if (b[d].transactionType == 0) {
                    ...
                    var i = 0;
                    try {
                        for (var _b = (e_4 = void 0, tslib_1.__values(fromEnum(h))), _c = _b.next(); !_c.done; _c = _b.next()) {
                            var j = _c.value;
                            f.keys[i] = j.key;
                            f.values[i] = j.value;
                            i++;
                    ...
                    var k = this.indexOfKey(e);
                    if (k > -1) {
                        f.item = this.getItemAtIndex(k);
                    }
                    else {
                        f.item = e;
                    }
    ...
    BaseDataSource.prototype.e = function (a) {
        if (a.length == 1 && typeCast(DataSourceSpecialRow.$, a[0]) !== null) {
            var b_2 = typeCast(DataSourceSpecialRow.$, a[0]);
            if (b_2.rowType == 3) {
                if (this.actualPrimaryKey != null) {
                    a = new Array(this.actualPrimaryKey.length);
                    this.getPrimaryKeyValue(b_2.targetRow, a);
                }
                else {
                    a = ((function () {
                        var $ret = new Array(1);
                        $ret.push(b_2.targetRow);
                        return $ret;
                    })());
                }
            }
    ...
    BaseDataSource.prototype.ax = function (a, b) {
        var c;
    ...
    BaseDataSource.prototype.onActualDataProviderChanged = function (a, b) {
        ...
        if (c != null) {
            c.schemaChanged = delegateRemove(c.schemaChanged, runOn(this, this.bl));
        }
        if (d != null) {
            d.schemaChanged = delegateCombine(d.schemaChanged, runOn(this, this.bl));
    ...
    BaseDataSource.prototype.bl = function (a, b) {
        var _this = this;
    ...
    BaseDataSource.prototype.queueAutoRefresh = function () {
        ...
        if (this.executionContext != null) {
            this.u = true;
            this.executionContext.enqueueAction(runOn(this, this.bn));
        }
    };
    BaseDataSource.prototype.bn = function () {
        if (this.deferAutoRefresh) {
            this.u = false;
            return;
        }
