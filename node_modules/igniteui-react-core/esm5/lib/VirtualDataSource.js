...
var VirtualDataSource = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function VirtualDataSource() {
        ...
        _this.cr = null;
        _this.cs = null;
        _this.c9 = new LRUCache$2(Base.$, IDataSourcePage_$type, 0, 200);
        _this.dg = new Dictionary$2(Base.$, Array_$type, 0);
        _this.dh = new Dictionary$2(Number_$type, Number_$type, 0);
        _this.db = false;
        _this.cp = null;
        _this.cu = null;
        _this.c8 = new SectionMap();
        _this.cq = null;
        _this.dr = -1;
        _this.dj = -1;
        _this.dt = -1;
        ...
        _this.dn = -1;
        _this.dq = -1;
        _this.df = new Dictionary$2(String_$type, Boolean_$type, 0);
        _this._concurrencyTag = null;
        _this.batchStarted = null;
        _this.batchCompleted = null;
        _this.c6 = new PagePredictionEngine();
        _this.c6.e = _this;
        _this.c6.ag = _this.actualPageSize;
        _this.c6.f = _this.c8;
        _this.executionContext = new DataSourceExecutionContext();
        _this.c6.b = _this.executionContext;
    ...
    Object.defineProperty(VirtualDataSource.prototype, "c2", {
        get: function () {
            return this.c1;
        },
        set: function (a) {
    ...
    VirtualDataSource.prototype.ej = function (a, b, c) {
        ...
        if (d != null) {
            d.execute(function () { return _this.ep(a, b, c); });
        }
        else {
            this.ep(a, b, c);
        }
    ...
    VirtualDataSource.prototype.eo = function () {
        var a = 0;
        var b = 0;
        var c = this.shouldEmitSectionHeaders;
        var d = this.shouldEmitSectionFooters;
        for (var e = 0; e < this.cp.length; e++) {
            var f = new SectionData();
            var g = b;
            var h = this.cp[e].endIndex - this.cp[e].startIndex;
            f.af = a;
            f.ae = e;
        ...
        var t = 0;
        for (var u = 0; u < this.c8.t.count; u++) {
            var v = this.c8.t._inner[u];
    ...
    VirtualDataSource.prototype.eh = function (a, b) {
        if (b) {
            this.cr = new Array(this.groupDescriptions.k.count);
            for (var c = 0; c < this.cr.length; c++) {
                this.cr[c] = a;
            }
        }
    ...
    VirtualDataSource.prototype.eg = function (a) {
    };
    ...
    VirtualDataSource.prototype.d1 = function (a) {
        if (this.an && this.c8.q) {
            var b = this.c8.g(a);
            if (b == null) {
                b = this.c8.d();
    ...
    VirtualDataSource.prototype.d6 = function (a) {
        if (a >= this.actualCount - this.dz) {
            var b = new DataSourceSpecialRow();
            b.rowType = 4;
            b.level = 0;
            var c = a - (this.actualCount - this.dz);
            var d = SectionData.r(this.cu);
    ...
    VirtualDataSource.prototype.cv = function (a) {
        if (this.an && this.c8.q) {
            var b = false;
            var c = this.c7(a);
            if (c == null) {
    ...
    VirtualDataSource.prototype.c7 = function (a) {
        return this.c8.e(a);
    };
    ...
    VirtualDataSource.prototype.d7 = function (a, b) {
        var c = this.d6(a);
    ...
    VirtualDataSource.prototype.ek = function (a) {
        if (this.dh.containsKey(a)) {
            this.dh.item(a, this.dh.item(a) - 1);
            if (this.dh.item(a) <= 0) {
    ...
    VirtualDataSource.prototype.removeCandidate = function (a) {
        if (this.dg.containsKey(a)) {
            for (var b = 0; b < this.dg.item(a).length; b++) {
                var c = this.dg.item(a)[b];
                this.ek(c);
            }
    ...
    VirtualDataSource.prototype.getUnrealizedCount = function () {
        var a = this.c9.g * this.actualPageSize;
    ...
    VirtualDataSource.prototype.eq = function () {
        var e_1, _a;
        if (this.actualDataProvider != null) {
            try {
                for (var _b = tslib_1.__values(fromEnum(this.dg.values)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var a = _c.value;
    ...
    VirtualDataSource.prototype.de = function (a, b) {
        if (a == null && b == null) {
            return true;
        }
        if (a == null || b == null) {
    ...
    VirtualDataSource.prototype.indexOfKey = function (a) {
        ...
        if (this.an && this.shouldEmitSectionHeaders && !this.isSectionContentVisible && this.isSectionHeaderNormalRow) {
            if (this.c8.t.count > 0) {
                for (var d = 0; d < this.c8.t.count; d++) {
                    var e = this.c8.t._inner[d];
    ...
    VirtualDataSource.prototype.c5 = function () {
    ...
    VirtualDataSource.prototype.getStickyRowsInRange = function (a, b) {
        ...
        if (this.c8.t.count > 0) {
            ...
            for (var f = this.actualCount - this.dz; f < this.actualCount; f++) {
                e.add(f);
            }
            return e.toArray();
        }
        ...
        for (var r = this.actualCount - this.dz; r < this.actualCount; r++) {
            g.add(r);
        }
        this.cq = g.toArray();
        return this.cq;
    ...
    VirtualDataSource.prototype.eb = function (a, b) {
        if (this.sectionHeaderDisplayMode == 0) {
            return this.ea(a);
        }
        var c = "";
    ...
    VirtualDataSource.prototype.ci = function (a, b) {
        if (a == 5) {
            var c = b;
            var d_1 = c.a;
    ...
    VirtualDataSource.prototype.ei = function (a, b, c) {
        if (b) {
            this.queueAutoRefresh();
        }
