...
export let ValueBrushScale = /*@__PURE__*/ (() => {
    class ValueBrushScale extends BrushScale {
        ...
        at(a, b, c) {
            if (this.ab && this.af > 0) {
                let d = logBase(a, this.af);
                let e = logBase(b, this.af);
                let f = logBase(c, this.af);
    ...
    ValueBrushScale.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, ValueBrushScale, 'u', ['IsLogarithmic', [0, false], 'LogarithmBase', [1, 10], 'MaximumValue', [1, NaN], 'MinimumValue', [1, NaN]]);
