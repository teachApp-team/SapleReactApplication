...
export declare class IgrFormatSpecifierCollection extends IgCollection<IgrFormatSpecifier, FormatSpecifier_internal> {
    constructor(list?: IgrFormatSpecifier[]);
    protected _createInnerColl(): SyncableObservableCollection$2<IgrFormatSpecifier, FormatSpecifier_internal>;
}
