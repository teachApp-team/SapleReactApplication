...
*/
export class IgrVerticalAnchoredCategorySeries extends IgrAnchoredCategorySeries {
    constructor(props) {
        super(props);
    ...
    */
    get xAxis() {
        ...
        if (!this.i.xAxis.externalObject) {
            let e = IgrNumericXAxis._createFromInternal(this.i.xAxis);
            if (e) {
    ...
    */
    get yAxis() {
        ...
        if (!this.i.yAxis.externalObject) {
            let e = IgrCategoryYAxis._createFromInternal(this.i.yAxis);
            if (e) {
    ...
    */
    canUseAsXAxis(axis) {
        let iv = this.i.p6(axis);
        return (iv);
    }
}
//# sourceMappingURL=igr-vertical-anchored-category-series.js.map
