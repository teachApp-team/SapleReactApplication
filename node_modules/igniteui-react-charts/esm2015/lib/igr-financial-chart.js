...
export class IgrFinancialChart extends IgrXYChart {
    ...
    */
    ...
    set volumeType(v) {
        this.i.p5 = ensureEnum(FinancialChartVolumeType_$type, v);
    }
    /**
    ...
    */
    ...
    set xAxisMode(v) {
        this.i.p7 = ensureEnum(FinancialChartXAxisMode_$type, v);
    }
    /**
    ...
    */
    ...
    set yAxisMode(v) {
        this.i.p9 = ensureEnum(FinancialChartYAxisMode_$type, v);
    }
    /**
    ...
    */
    ...
    set chartType(v) {
        this.i.p0 = ensureEnum(FinancialChartType_$type, v);
    }
    /**
    ...
    */
    ...
    set zoomSliderType(v) {
        this.i.qc = ensureEnum(FinancialChartZoomSliderType_$type, v);
    }
    /**
    ...
    */
    get negativeBrushes() {
        return fromBrushCollection(this.i.o9);
    }
    set negativeBrushes(v) {
        this.i.o9 = toBrushCollection(v);
    }
    /**
    ...
    */
    get negativeOutlines() {
        return fromBrushCollection(this.i.pa);
    }
    set negativeOutlines(v) {
        this.i.pa = toBrushCollection(v);
    }
    /**
    ...
    */
    get overlayBrushes() {
        return fromBrushCollection(this.i.pb);
    }
    set overlayBrushes(v) {
        this.i.pb = toBrushCollection(v);
    }
    /**
    ...
    */
    get overlayOutlines() {
        return fromBrushCollection(this.i.pc);
    }
    set overlayOutlines(v) {
        this.i.pc = toBrushCollection(v);
    }
    /**
    ...
    */
    get volumeOutlines() {
        return fromBrushCollection(this.i.pe);
    }
    set volumeOutlines(v) {
        this.i.pe = toBrushCollection(v);
    }
    /**
    ...
    */
    get volumeBrushes() {
        return fromBrushCollection(this.i.pd);
    }
    set volumeBrushes(v) {
        this.i.pd = toBrushCollection(v);
    }
    /**
    ...
    */
    get indicatorNegativeBrushes() {
        return fromBrushCollection(this.i.o8);
    }
    set indicatorNegativeBrushes(v) {
        this.i.o8 = toBrushCollection(v);
    }
    /**
    ...
    */
    get indicatorBrushes() {
        return fromBrushCollection(this.i.o7);
    }
    set indicatorBrushes(v) {
        this.i.o7 = toBrushCollection(v);
    }
    /**
