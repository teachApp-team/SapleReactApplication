    ...
    class RearrangedListView extends Base {
        ...
        b1() {
            ...
            if (this.m.isSectionContentVisible || !this.av) {
                ...
                for (let af = 0; af < this.a4.count; af++) {
                    let ag = this.a4._inner[af];
                    if (ag == null) {
                        continue;
                    }
                    if (h == null) {
                        let ah = this.x(af, ag, c);
                        ...
                        if (this.a1.compare(h, ag) != 0) {
                            let ai = this.z.t._inner[this.z.t.count - 1];
                            this.bt(g.count - 1, i, b);
                            let aj = this.x(af, ag, c);
                            this.bs(aj, false, f);
            ...
            for (let am = 0; am < this.b.length; am++) {
                this.a[am] = null;
                this.b[am] = null;
            }
            this.c = null;
